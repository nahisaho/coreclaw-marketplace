...
description: |
 paper's Supplementary Information (SI) automatedgeneratesskill。
 papersfromfigures/tablesmethoddetailsadditiondata structure、
 SI is generated。「SI」「 generation」「Supplementary 」 。
 scientific-academic-writing papers for。
tu_tools:
 - key: crossref
 name: Crossref
