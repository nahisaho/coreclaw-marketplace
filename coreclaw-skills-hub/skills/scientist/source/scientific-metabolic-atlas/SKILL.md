...
description: |
 metabolismskill。Metabolic Atlas / Human-GEM REST API by/via
 metabolismreactionmetabolismsearch、analysisintegration、
 metabolismnetworkvisualization。K-Dense integration: metabolic-atlas。
 ToolUniverse integration: metabolic_atlas。
tu_tools: []
