...
description: |
 PRISMA 2020 systematic reviewskill。 DB search
 (PubMed/Embase/Cochrane/Web of Science)、workflow
 (title/→all)、evaluation (RoB 2/ROBINS-I/NOS)、dataextraction
 template、PRISMA figureautomatedgenerationpipeline。
---
...
> PubMed/EuropePMC tool `scientific-literature-search` skilland 。

| Category | Key Tools | Usage |
|---|---|---|
| PubMed | `PubMed_search_articles` | phylogenysearch |
| PubMed | `PubMed_Guidelines_Search` | guideline search |
| EuropePMC | `EuropePMC_search_articles` | literaturesearch |
