...
description: |
 protein-proteininteraction (PPI) networkanalysisskill。STRING、IntAct、
 BioGRID、STITCH (-protein) interactiondatabaseintegration
 networkconstructionanalysispipeline。GO/KEGG 、interaction、
 tissuenetwork (HumanBase)、compound-networksupport。
 14 's ToolUniverse SMCP tool and integration。
tu_tools:
 - key: intact
 name: IntAct
