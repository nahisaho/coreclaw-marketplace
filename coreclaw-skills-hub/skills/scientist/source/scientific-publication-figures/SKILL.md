...
description: |
 paper（Nature/Science/Cell ）'sfigures/tables is createdskill。matplotlib rcParams settings、
 DPI 300、spines 、color paletteselection、configuration is performedfor。
 Scientific Skills Exp-10 、Exp-11〜13 。
---
