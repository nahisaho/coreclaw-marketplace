...
description: |
 Experimental Designskill。 (Thompson Sampling/UCB)
 Bayesiandesigntesting (SPRT)
 Response-Adaptive Randomizationrules。
---
...
def bayesian_adaptive_dose_finding(dose_levels, n_patients=30,
 ...
 # 's foramountselection (also target toxicityrate)
