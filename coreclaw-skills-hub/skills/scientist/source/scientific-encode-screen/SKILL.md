...
description: |
 ...
 ToolUniverse integration: encode, chipatlas。
tu_tools:
 - key: encode
 name: ENCODE
 description: ENCODE 's experimentfiledatasearch
 - key: chipatlas
 name: ChIP-Atlas
 description: ChIP-seq/ATAC-seq analysispeak
---
...
|--------|---------|---------|
| `encode` | ENCODE | experimentfilesearch |
| `chipatlas` | ChIP-Atlas | factoranalysis |
