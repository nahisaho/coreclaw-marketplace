...
description: |
 simulationskill。Monte Carlo methodBootstrap inference
 Permutation Testpowerminrateevaluation。
tu_tools:
 - key: biotools
 name: bio.tools
 description: simulationtoolsearch
---
...
|--------|---------|--------|
| `biotools` | bio.tools | simulationtoolsearch |
---
