...
|---|---|---|
| PubMed | `PubMed_search_articles` | researchsearch |
| PubMed | `PubMed_get_cited_by` | citation structure analysis |
| EuropePMC | `EuropePMC_search_articles` | European literature search |
| Crossref | `Crossref_search_works` | DOIpublication information search |
| OpenAlex | `OpenAlex_Guidelines_Search` | literaturesearch |
