...
description: |
 experimentautomatedprotocolskill。PyLabRobot（）、
 Protocols.io（protocol）、Benchling/LabArchives（ELN/LIMS integration）、
 Opentrons（）by/viaexperimentautomatedand reproducibilitysupport。
 claude-scientific-skills 's Lab Automation integration。
 「experimentprotocol」「 automated」 。
tu_tools:
 - key: biotools
 name: bio.tools
