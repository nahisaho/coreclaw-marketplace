...
description: |
 analysisskill。Pareto 、PLS-DA + VIP 、testing（Q²）、
 metabolismpathwayanalysis（Fisher exact test）、metabolitecorrelationnetwork、
 Volcano plot/box plotby/viametabolitepipeline。
 Scientific Skills Exp-07 。
---
