...
description: |
 geneskill。ClinVar / gnomAD / COSMIC / ACMG 
 evaluation、（PharmGKB/ClinPGx）、-tabletypecorrelation's
 。ToolUniverse 's Variant Interpretation integration。
 「's evaluation」「pharmacogenomics analysis」 。
tu_tools:
 - key: clinvar
 name: ClinVar
