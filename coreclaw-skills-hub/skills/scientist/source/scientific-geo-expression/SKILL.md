...
description: |
 GEO (Gene Expression Omnibus) expressionfileskill。GEO REST
 API Dataset Searchinformationexpressionretrievalbulk
 RNA-seq/expressionanalysis。ToolUniverse integration: geo。
tu_tools:
 - key: geo
