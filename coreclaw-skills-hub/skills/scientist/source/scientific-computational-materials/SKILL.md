...
description: |
 calculationskill。pymatgen by/viacrystal structureanalysis、
 Materials Project API by/viadatabase、
 phase diagramcalculation (analysis)、band structuredensity of states (DOS) visualization、
 VASP/Quantum ESPRESSO output、looppipeline。
---
...
> External tools available via [ToolUniverse](https://github.com/mims-harvard/ToolUniverse) SMCP.
 ...
 — Materials Project API (mp-api) use。
