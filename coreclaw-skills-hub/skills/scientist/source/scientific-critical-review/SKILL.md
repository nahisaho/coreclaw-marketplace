...
description: |
 paper'sfor/againstfixskill。configuration、discussion's 、
 data's 、research and 's、's verification、
 fix is generated。「paper」「discussion 」「 improvement」 。
 scientific-academic-writing 's cell for。
tu_tools:
 - key: crossref
 name: Crossref
 description: paperverificationcitationdatareference
---
...
|--------|---------|--------|
| `crossref` | Crossref | paperverificationcitationdatareference |
