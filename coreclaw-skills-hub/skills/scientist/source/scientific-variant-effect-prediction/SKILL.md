...
description: |
 calculationpredictionskill。AlphaMissense (proteinstructureprediction)、
 CADD (integrationannotation)、SpliceAI (prediction) 's 
 3 predictiontool integrationevaluationpipeline。
 Ensembl VEP integration、filter、support。
 9 's ToolUniverse SMCP tool and integration。
tu_tools:
 - key: spliceai
 name: SpliceAI
