...
description: |
 Markdown LaTeX shapeformula transformation、specification'stemplate（.cls/.sty） 
 is performedskill。number/countformulafigures/tablescitationphasereference's LaTeX transformation、
 for、possible.tex filegeneration。
 「LaTeX transformation」「for TeX 」「 」 。
---
