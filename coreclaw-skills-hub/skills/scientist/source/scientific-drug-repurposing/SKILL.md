...
description: |
 （existing）skill。ToolUniverse 's Drug Repurposing
 、7 items's（type、compoundtype、diseasetype、type、
 networktype、tabletype、structuretype）systematicsearch/exploration。
 「」「existing's novel 」 。
tu_tools:
 - key: pharos
 name: Pharos
