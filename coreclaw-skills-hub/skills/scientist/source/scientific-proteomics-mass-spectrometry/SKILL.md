...
description: |
 proteomicsmass spectrometryanalysisskill。LC-MS/MS datapreprocessing、peptide (PSM/FDR )、
 amount (LFQ/TMT/SILAC/iBAQ)、 (PTM) mapping、
 spectrumdegree (/fix)、molecule (GNPS)、
 compoundannotation (HMDB/MassBank) integrationmass spectrometrypipeline。
 pyOpenMS / matchms 'sworkflow。
---
