...
description: |
 analysisskill。（ODE / SBML）
 metabolismanalysis（FBA / pFBA）genenetwork（GRN）
 signal transductionparametersdegreeanalysis
 BioModels/Reactome/KEGG/BiGG integrationpipeline。
 ToolUniverse integration: bigg_models, complex_portal, wikipathways。
tu_tools:
 - key: bigg_models
 name: BiGG Models
