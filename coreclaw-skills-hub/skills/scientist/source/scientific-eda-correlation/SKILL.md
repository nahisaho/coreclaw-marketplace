...
description: |
 search/explorationdataanalysis（EDA）and correlationmin'sskill。data'sdistributionvisualization、correlationheatmap、
 scatter plot's is performedfor。Scientific Skills Exp-02, 12, 13 。
tu_tools:
 - key: biotools
 name: bio.tools
