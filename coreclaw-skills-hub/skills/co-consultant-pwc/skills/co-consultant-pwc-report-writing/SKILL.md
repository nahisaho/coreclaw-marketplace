---
name: co-consultant-pwc-report-writing
description: |
  PwC-style consulting report generation with pyramid principle and quality validation.
  Executive summary, framework outputs, recommendations, and 4-layer quality checks.
  Use when WRITING PWC consulting reports, proposals, executive summaries,
  or client-ready deliverables from PWC framework analysis results.
---

# Report Writing (PWC)

Generate PwC-style pyramid-principle reports with quality validation.

## Use This Skill When

- Writing a PWC-style consulting deliverable.
- Creating an executive summary for decision-makers.
- Formatting PWC framework outputs into a client report.
...
- `report.md`: complete PWC-style consulting report.
...
- [ ] Report follows PWC methodology and conventions.
...
- PWCフレームワークの出力は必ずレポートに統合すること。フレームワーク結果だけの羅列は不可
