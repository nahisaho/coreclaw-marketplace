---
name: co-consultant-pwc-deep-research
description: |
  Iterative deep research with Think→Action→Report cycle for PwC-style engagements.
  ...
  or gathering evidence for PWC framework application.
tu_tools:
  - key: deep-research
...
Hypothesis-driven iterative research for PwC-style consulting.

## Use This Skill When

- Collecting market, competitive, or technology intelligence.
- Verifying business data from multiple sources.
- Gathering evidence before applying PWC frameworks.
...
web_search("PwC PWC framework case study")
```
...
- PwCのレポート・出版物は信頼度「高」として扱うが、自社バイアスに注意すること
