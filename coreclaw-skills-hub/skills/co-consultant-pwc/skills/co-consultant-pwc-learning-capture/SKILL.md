---
name: co-consultant-pwc-learning-capture
description: |
  Consulting learning capture for PwC-style engagements.
  Records framework insights, engagement patterns, and methodology lessons.
  Use when FINISHING a PWC engagement, discovering a framework limitation,
  or recording lessons for future PwC-style consulting sessions.
---

# Learning Capture (PWC)

Record PwC-style consulting learnings for Memory Persistence.

## Use This Skill When

- Completing a PWC consulting engagement.
- Discovering a PWC framework limitation or edge case.
- Recording lessons for future PwC-style engagements.
