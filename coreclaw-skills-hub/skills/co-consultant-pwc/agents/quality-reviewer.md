...
description: >
  Read-only PwC-style quality reviewer. Audits MECE completeness,
  PWC framework application, pyramid structure, and evidence quality.
tools:
  - read_file
  - grep_search
  - list_directory
