...
description: >
  Read-only McKinsey-style quality reviewer. Audits MECE completeness,
  MCK framework application, pyramid structure, and evidence quality.
tools:
  - read_file
  - grep_search
  - list_directory
