---
name: co-scientist-metabolic-modeling
description: |
  ...
  Use when working with constraint-based metabolic modeling (cobrapy), genome-scale model construction, gene knockout simulation.
---
...
- Genome-scale model construction.
- Gene knockout simulation.
- Metabolic engineering predictions.
