---
name: co-scientist-ontology-enrichment
description: |
  ...
  Use when working with go enrichment analysis, kegg pathway enrichment, disease ontology enrichment.
tu_tools:
  - key: go
    name: Gene Ontology
---
...
| Gene Ontology | `GO_search_term` | Gene Ontology API |
