---
name: co-scientist-hgnc-nomenclature
description: |
  ...
  Use when working with official gene symbol resolution, gene name standardization, symbol history tracking.
tu_tools:
  - key: hgnc
    name: HGNC
---
...
- Official gene symbol resolution.
- Gene name standardization.
- Symbol history tracking.
- Gene family classification via HGNC database.
...
|--------|------|-------------|
| HGNC | `HGNC_search` | HGNC API |
| HGNC | `HGNC_get_gene` | HGNC API |
