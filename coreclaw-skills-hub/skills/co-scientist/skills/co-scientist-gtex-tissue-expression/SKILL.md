---
name: co-scientist-gtex-tissue-expression
description: |
  ...
  Use when working with tissue-specific gene expression queries from gtex portal, eqtl analysis, cross-tissue comparison.
tu_tools:
  - key: gtex
    name: GTEx
---
...
- Tissue-specific gene expression queries from GTEx portal.
- EQTL analysis.
...
|--------|------|-------------|
| GTEx | `GTEx_get_expression` | GTEx API |
| GTEx | `GTEx_search_genes` | GTEx API |
