...
description: |
  ...
  Use when working with pathway diagrams, mechanism illustrations, experimental workflow diagrams.
---
...
- Scientific concept visualization generation.
