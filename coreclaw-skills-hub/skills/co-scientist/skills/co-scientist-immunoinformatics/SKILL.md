---
name: co-scientist-immunoinformatics
description: |
  ...
  Use when working with epitope prediction, mhc binding analysis, tcr/bcr repertoire analysis.
tu_tools:
  - key: iedb
    name: IEDB
---
...
|--------|------|-------------|
| IEDB | `IEDB_search_epitopes` | IEDB API |
| IEDB | `IEDB_get_assays` | IEDB API |
