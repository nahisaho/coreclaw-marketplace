---
name: co-scientist-nci60-screening
description: |
  ...
  Use when working with nci-60 cancer cell line panel data analysis, drug sensitivity profiling, compare algorithm.
tu_tools:
  - key: nci60
    name: NCI-60
---
...
- NCI-60 cancer cell line panel data analysis.
- Drug sensitivity profiling.
- COMPARE algorithm.
- Multi-drug response comparison.
...
|--------|------|-------------|
| NCI-60 | `NCI60_search_compounds` | NCI-60 API |
| NCI-60 | `NCI60_get_activity` | NCI-60 API |
