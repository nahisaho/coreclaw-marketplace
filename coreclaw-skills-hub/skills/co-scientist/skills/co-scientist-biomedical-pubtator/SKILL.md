---
name: co-scientist-biomedical-pubtator
description: |
  ...
  Use when working with named entity recognition for genes, diseases, chemicals.
tu_tools:
  - key: pubtator
    name: PubTator3
---
...
| PubTator3 | `PubTator_get_annotations` | PubTator3 API |
