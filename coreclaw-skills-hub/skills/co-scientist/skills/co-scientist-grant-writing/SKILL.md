---
name: co-scientist-grant-writing
description: |
  ...
  Use when working with research proposal drafting, specific aims composition, budget justification.
---
...
- Specific aims composition.
- Budget justification.
- Significance/innovation statements.
- Funding agency format compliance.
