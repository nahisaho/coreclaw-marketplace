---
name: co-scientist-data-submission
description: |
  ...
  Use when working with geo/sra/ena/ddbj data deposition, metadata preparation, compliance with fair principles.
---
...
- GEO/SRA/ENA/DDBJ data deposition.
- Metadata preparation.
- Compliance with FAIR principles.
- Repository-specific format conversion.
