---
name: co-scientist-metabolic-flux
description: |
  ...
  Use when working with ¹³c metabolic flux analysis, flux balance analysis, flux variability analysis.
---
...
- Metabolic network constraint-based modeling.
