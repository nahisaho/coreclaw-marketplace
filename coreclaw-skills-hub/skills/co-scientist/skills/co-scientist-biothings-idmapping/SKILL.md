---
name: co-scientist-biothings-idmapping
description: |
  ...
  Use when working with gene/variant/chemical/disease identifier conversion using mygene.info, myvariant.info, mychem.info apis.
tu_tools:
  - key: biothings
    name: BioThings
---
...
|--------|------|-------------|
| BioThings | `BioThings_query_gene` | BioThings API |
| BioThings | `BioThings_query_variant` | BioThings API |
