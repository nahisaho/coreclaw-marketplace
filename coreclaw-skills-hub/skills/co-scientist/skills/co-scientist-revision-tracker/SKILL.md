---
name: co-scientist-revision-tracker
description: |
  ...
  Use when working with manuscript revision tracking, diff generation between drafts, change log maintenance.
---
...
- Diff generation between drafts.
- Change log maintenance.
- Reviewer comment integration management.
