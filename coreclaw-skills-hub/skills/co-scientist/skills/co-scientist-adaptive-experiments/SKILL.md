---
name: co-scientist-adaptive-experiments
description: |
  ...
  Use when working with sequential experiment optimization, bayesian optimization, multi-armed bandit.
---
...
- Interim analysis for efficient experimental workflows.
