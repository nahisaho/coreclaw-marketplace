---
name: co-scientist-latex-export
description: |
  ...
  Use when working with markdown-to-latex conversion, journal-specific latex template generation, bibliography management.
---
...
- Journal-specific LaTeX template generation.
- Bibliography management.
- Publication-ready PDF compilation.
