---
name: co-scientist-encode-screen
description: |
  ...
  Use when working with encode project data access, regulatory element annotation, epigenomic data analysis.
tu_tools:
  - key: encode
    name: ENCODE
---
...
- Functional genomics screen result interpretation.
