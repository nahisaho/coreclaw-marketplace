---
name: co-scientist-clinical-reporting
description: |
  ...
  Use when working with structured clinical study reports, consort/strobe compliance, patient demographics tables.
---
...
- Structured clinical study reports.
