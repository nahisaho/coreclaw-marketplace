---
name: co-scientist-variant-interpretation
description: |
  ...
  Use when working with acmg/amp variant classification, pathogenicity evidence aggregation, clinical significance assessment.
tu_tools:
  - key: clinvar
    name: ClinVar
  - key: gnomad
...
- Pathogenicity evidence aggregation.
...
| ClinVar | `ClinVar_get_variant` | ClinVar API |
