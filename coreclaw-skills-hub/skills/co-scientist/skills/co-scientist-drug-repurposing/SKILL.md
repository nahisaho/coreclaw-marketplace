---
name: co-scientist-drug-repurposing
description: |
  ...
  Use when working with computational drug repositioning, network-based prediction, molecular similarity-based repurposing.
tu_tools:
  - key: drugbank
    name: DrugBank
  - key: chembl
...
- Molecular similarity-based repurposing.
- Clinical trial evidence mining for new indications.
...
|--------|------|-------------|
| DrugBank | `DrugBank_search` | DrugBank API |
