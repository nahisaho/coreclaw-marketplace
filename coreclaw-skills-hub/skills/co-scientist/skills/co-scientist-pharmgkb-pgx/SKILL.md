---
name: co-scientist-pharmgkb-pgx
description: |
  ...
  Use when working with pharmgkb clinical annotation queries, drug-gene interaction lookup, dosing guideline retrieval.
tu_tools:
  - key: pharmgkb
    name: PharmGKB
---
...
- PharmGKB clinical annotation queries.
- Drug-gene interaction lookup.
- Dosing guideline retrieval.
- Pharmacogenomic pathway analysis.
...
|--------|------|-------------|
| PharmGKB | `PharmGKB_search` | PharmGKB API |
| PharmGKB | `PharmGKB_get_guideline` | PharmGKB API |
| PharmGKB | `PharmGKB_get_drug` | PharmGKB API |
