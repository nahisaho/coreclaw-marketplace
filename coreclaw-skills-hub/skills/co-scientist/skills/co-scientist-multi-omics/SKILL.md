...
description: |
  ...
  Use when working with genomics/transcriptomics/proteomics/metabolomics data integration, multi-omics factor analysis (mofa), pathway-level integration.
tu_tools:
  - key: ensembl
    name: Ensembl
  - key: uniprot
...
- Genomics/transcriptomics/proteomics/metabolomics data integration.
