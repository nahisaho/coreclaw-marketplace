---
name: co-scientist-clinical-trials-analytics
description: |
  ...
  Use when working with trial design comparison, enrollment simulation, interim analysis.
tu_tools:
  - key: clinicaltrials
...
- Interim analysis.
- Survival analysis.
- Adverse event signal detection from ClinicalTrials.gov data.
...
|--------|------|-------------|
| ClinicalTrials.gov | `ClinicalTrials_search` | ClinicalTrials.gov API |
| ClinicalTrials.gov | `ClinicalTrials_get_study` | ClinicalTrials.gov API |
