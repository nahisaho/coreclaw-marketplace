---
name: co-scientist-ml-regression
description: |
  ...
  Use when working with linear/nonlinear regression, regularization (l1/l2/elasticnet), polynomial features.
---
...
- Polynomial features.
- Cross-validation.
- Regression diagnostics pipelines.
