---
name: co-scientist-deep-chemistry
description: |
  ...
  Use when working with graph neural networks for molecular property prediction, molecular generation with vae/gan, reaction prediction.
tu_tools:
  - key: pubchem
    name: PubChem
---
...
- Molecular generation with VAE/GAN.
- Reaction prediction.
