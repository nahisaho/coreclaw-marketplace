---
name: co-scientist-noncoding-rna
description: |
  ...
  Use when working with mirna target prediction, lncrna functional annotation, ncrna expression analysis.
---
...
- NcRNA expression analysis.
- Small RNA-seq processing.
