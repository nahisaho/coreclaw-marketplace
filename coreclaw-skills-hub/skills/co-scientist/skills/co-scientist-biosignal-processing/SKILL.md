---
name: co-scientist-biosignal-processing
description: |
  ...
  Use when working with eeg, ecg, emg signal processing with filtering.
---
...
- EEG.
- ECG.
- EMG signal processing with filtering.
- Spectral analysis.
- Wavelet transforms.
...
- DICOM metadata contains patient identifiers. Strip PHI before sharing or analysis
- Resolution and pixel spacing differences between scanners must be harmonized before comparison
