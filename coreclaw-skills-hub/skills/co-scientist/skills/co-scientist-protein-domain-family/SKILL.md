---
name: co-scientist-protein-domain-family
description: |
  ...
  Use when working with interpro/pfam domain annotation, protein family classification, domain architecture analysis.
tu_tools:
  - key: interpro
    name: InterPro
  - key: uniprot
...
|--------|------|-------------|
| InterPro | `InterPro_search` | InterPro API |
| InterPro | `InterPro_get_entry` | InterPro API |
| UniProt | `UniProt_get_features` | UniProt API |
