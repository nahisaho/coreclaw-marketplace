---
name: co-scientist-gnomad-variants
description: |
  ...
  Use when working with gnomad variant skill. population allele frequency queries, variant filtering, loss-of-function constraint metrics.
tu_tools:
  - key: gnomad
    name: gnomAD
---
...
- GnomAD variant skill. Population allele frequency queries.
- Variant filtering.
- Loss-of-function constraint metrics.
- Clinical variant annotation from gnomAD database.
...
|--------|------|-------------|
| gnomAD | `gnomAD_get_variant` | gnomAD API |
| gnomAD | `gnomAD_search_gene` | gnomAD API |
