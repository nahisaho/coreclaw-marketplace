---
name: co-scientist-drug-target-profiling
description: |
  ...
  Use when working with target identification, binding affinity prediction, selectivity profiling.
tu_tools:
  - key: chembl
    name: ChEMBL
  - key: drugbank
...
- Target deconvolution pipelines.
