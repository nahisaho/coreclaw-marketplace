---
name: co-scientist-cell-line-resources
description: |
  ...
  Use when working with cellosaurus, atcc, depmap cell line data retrieval.
tu_tools:
  - key: cellosaurus
    name: Cellosaurus
---
...
- Cellosaurus.
- ATCC.
- DepMap cell line data retrieval.
...
|--------|------|-------------|
| Cellosaurus | `Cellosaurus_search` | Cellosaurus API |
| Cellosaurus | `Cellosaurus_get_cell_line` | Cellosaurus API |
