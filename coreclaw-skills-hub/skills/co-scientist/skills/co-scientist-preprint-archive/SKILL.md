---
name: co-scientist-preprint-archive
description: |
  ...
  Use when working with biorxiv/medrxiv/arxiv search, preprint tracking, citation monitoring.
tu_tools:
  - key: europepmc
    name: EuropePMC
...
- BioRxiv/medRxiv/arXiv search.
- Preprint tracking.
- Citation monitoring.
- Preprint-to-publication linking.
