---
name: co-scientist-population-genetics
description: |
  ...
  Use when working with allele frequency analysis, hardy-weinberg testing, fst/neutrality statistics.
tu_tools:
  - key: gnomad
    name: gnomAD
  - key: ensembl
...
- Fst/neutrality statistics.
- Population structure (ADMIXTURE/PCA).
