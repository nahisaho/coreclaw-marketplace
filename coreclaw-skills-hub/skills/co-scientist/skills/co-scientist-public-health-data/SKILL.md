---
name: co-scientist-public-health-data
description: |
  ...
  Use when working with who/cdc/national health data retrieval, health indicator analysis, demographic health survey processing.
tu_tools:
  - key: who
    name: WHO GHO
---
...
- WHO/CDC/national health data retrieval.
- Health indicator analysis.
- Demographic health survey processing.
- Public health metric calculation.
...
|--------|------|-------------|
| WHO GHO | `WHO_get_indicators` | WHO GHO API |
