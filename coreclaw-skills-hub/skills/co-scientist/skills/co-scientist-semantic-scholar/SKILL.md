---
name: co-scientist-semantic-scholar
description: |
  ...
  Use when working with academic paper search via semantic scholar api, citation graph exploration, author profiling.
tu_tools:
...
- Author profiling.
- Research impact metrics retrieval.
