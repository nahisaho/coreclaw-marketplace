---
name: co-scientist-stitch-chemical-network
description: |
  ...
  Use when working with stitch chemical-protein interaction queries, chemical similarity networks, drug-target network construction.
tu_tools:
  - key: stitch
    name: STITCH
---
...
|--------|------|-------------|
| STITCH | `STITCH_get_interactions` | STITCH API |
| STITCH | `STITCH_search` | STITCH API |
