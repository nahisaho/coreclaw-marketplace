---
name: co-scientist-string-network-api
description: |
  ...
  Use when working with protein-protein interaction network queries, functional enrichment via string, network clustering.
tu_tools:
  - key: string
    name: STRING
---
...
- Protein-protein interaction network queries.
...
|--------|------|-------------|
| STRING | `STRING_get_interactions` | STRING API |
| STRING | `STRING_get_enrichment` | STRING API |
