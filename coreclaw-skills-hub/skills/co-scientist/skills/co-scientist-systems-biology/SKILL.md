---
name: co-scientist-systems-biology
description: |
  ...
  Use when working with network modeling, flux balance analysis, dynamical systems simulation.
tu_tools:
  - key: reactome
    name: Reactome
  - key: string
...
- Multi-scale biological system analysis.
