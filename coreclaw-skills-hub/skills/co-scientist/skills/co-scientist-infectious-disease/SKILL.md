---
name: co-scientist-infectious-disease
description: |
  ...
  Use when working with pathogen genomics, antimicrobial resistance prediction, epidemiological modeling.
tu_tools:
  - key: ncbi_virus
    name: NCBI Virus
---
...
|--------|------|-------------|
| NCBI Virus | `NCBIVirus_search` | NCBI Virus API |
| NCBI Virus | `NCBIVirus_get_sequence` | NCBI Virus API |
