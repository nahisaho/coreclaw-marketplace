---
name: co-scientist-interactive-dashboard
description: |
  ...
  Use when working with streamlit/plotly dash scientific dashboard creation, real-time data visualization, parameter exploration interfaces.
---
...
- Streamlit/Plotly Dash scientific dashboard creation.
