---
name: co-scientist-epidemiology-public-health
description: |
  ...
  Use when working with disease surveillance, outbreak analysis, incidence/prevalence estimation.
tu_tools:
  - key: who
    name: WHO GHO
---
...
| WHO GHO | `WHO_get_data` | WHO GHO API |
