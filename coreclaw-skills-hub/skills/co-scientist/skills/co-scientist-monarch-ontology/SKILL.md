---
name: co-scientist-monarch-ontology
description: |
  ...
  Use when working with monarch initiative queries for disease-gene associations, phenotype ontology navigation, cross-species phenotype comparison.
tu_tools:
  - key: monarch
...
- Monarch Initiative queries for disease-gene associations.
- Phenotype ontology navigation.
...
|--------|------|-------------|
| Monarch Initiative | `Monarch_search` | Monarch Initiative API |
| Monarch Initiative | `Monarch_get_associations` | Monarch Initiative API |
