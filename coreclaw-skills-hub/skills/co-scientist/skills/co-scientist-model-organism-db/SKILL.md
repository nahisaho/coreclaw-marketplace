---
name: co-scientist-model-organism-db
description: |
  ...
  Use when working with flybase/wormbase/sgd/zfin/mgi queries, ortholog mapping, phenotype data retrieval.
tu_tools:
  - key: mgi
    name: MGI
---
...
- FlyBase/WormBase/SGD/ZFIN/MGI queries.
- Ortholog mapping.
...
|--------|------|-------------|
| MGI | `MGI_search_gene` | MGI API |
| MGI | `MGI_get_phenotypes` | MGI API |
