---
name: co-scientist-metabolic-atlas
description: |
  ...
  Use when working with genome-scale metabolic model queries, metabolic pathway visualization, flux balance analysis results.
tu_tools:
  - key: metabolicatlas
...
|--------|------|-------------|
| Metabolic Atlas | `MetabolicAtlas_search` | Metabolic Atlas API |
| Metabolic Atlas | `MetabolicAtlas_get_reaction` | Metabolic Atlas API |
