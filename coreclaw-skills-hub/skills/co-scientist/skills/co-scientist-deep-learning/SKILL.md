---
name: co-scientist-deep-learning
description: |
  ...
  Use when working with pytorch/tensorflow model building, cnn/rnn/transformer architectures, training optimization.
---
...
- PyTorch/TensorFlow model building.
