---
name: co-scientist-lab-automation
description: |
  ...
  Use when working with laboratory workflow automation, instrument control scripting, sample tracking.
---
