---
name: co-scientist-scvi-integration
description: |
  ...
  Use when working with scvi integration skill. deep generative model-based single-cell analysis with scvi-tools, batch correction, cell type annotation.
---
...
- ScVI integration skill. Deep generative model-based single-cell analysis with scvi-tools.
- Batch correction.
