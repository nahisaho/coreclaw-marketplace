---
name: co-scientist-variant-effect-prediction
description: |
  ...
  Use when working with cadd/revel/alphamissense scoring, splice variant prediction, regulatory variant impact.
tu_tools:
  - key: ensembl
    name: Ensembl
  - key: gnomad
...
- CADD/REVEL/AlphaMissense scoring.
- Splice variant prediction.
- Regulatory variant impact.
...
|--------|------|-------------|
| Ensembl | `Ensembl_vep` | Ensembl API |
