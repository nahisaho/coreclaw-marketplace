---
name: co-scientist-opentargets-genetics
description: |
  ...
  Use when working with gwas trait-gene associations, l2g scoring, colocation analysis.
tu_tools:
  - key: opentargets
    name: Open Targets
---
...
|--------|------|-------------|
| Open Targets | `OpenTargets_search_target` | Open Targets API |
| Open Targets | `OpenTargets_get_associations` | Open Targets API |
