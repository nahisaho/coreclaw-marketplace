---
name: co-scientist-cancer-genomics
description: |
  ...
  Use when working with somatic mutation analysis, copy number variation, tumor mutational burden.
tu_tools:
  - key: cosmic
    name: COSMIC
  - key: cbioportal
...
|--------|------|-------------|
| COSMIC | `COSMIC_search_mutations` | COSMIC API |
| COSMIC | `COSMIC_get_mutations_by_gene` | COSMIC API |
| cBioPortal | `cBioPortal_get_studies` | cBioPortal API |
| cBioPortal | `cBioPortal_get_mutations` | cBioPortal API |
