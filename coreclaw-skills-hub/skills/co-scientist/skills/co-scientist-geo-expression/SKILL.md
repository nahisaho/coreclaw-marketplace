---
name: co-scientist-geo-expression
description: |
  ...
  Use when working with gene expression omnibus data retrieval, microarray/rna-seq dataset processing, geo2r analysis.
tu_tools:
  - key: geo
    name: GEO
---
...
- Gene Expression Omnibus data retrieval.
- Microarray/RNA-seq dataset processing.
- GEO2R analysis.
...
|--------|------|-------------|
| GEO | `GEO_search_datasets` | GEO API |
| GEO | `GEO_get_dataset` | GEO API |
| GEO | `GEO_get_samples` | GEO API |
