---
name: co-scientist-pharmacogenomics
description: |
  ...
  Use when working with genotype-drug response associations, pharmacogenomic variant annotation, dosing guideline integration.
tu_tools:
  - key: pharmgkb
    name: PharmGKB
---
...
- Genotype-drug response associations.
- Pharmacogenomic variant annotation.
- Dosing guideline integration.
- PGx biomarker analysis.
