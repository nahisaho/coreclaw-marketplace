---
name: co-scientist-human-protein-atlas
description: |
  ...
  Use when working with protein expression data retrieval, tissue/cell/pathology atlas queries, subcellular localization.
tu_tools:
  - key: hpa
...
- Protein expression data retrieval.
- Tissue/cell/pathology atlas queries.
- Subcellular localization.
- Protein classification from HPA database.
...
|--------|------|-------------|
| Human Protein Atlas | `HPA_search_gene` | Human Protein Atlas API |
| Human Protein Atlas | `HPA_get_expression` | Human Protein Atlas API |
