---
name: co-scientist-disease-research
description: |
  ...
  Use when working with disease ontology queries, phenotype-genotype associations, clinical feature extraction.
tu_tools:
  - key: disgenet
    name: DisGeNET
---
...
|--------|------|-------------|
| DisGeNET | `DisGeNET_search` | DisGeNET API |
| DisGeNET | `DisGeNET_get_associations` | DisGeNET API |
