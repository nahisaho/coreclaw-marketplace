---
name: co-scientist-publication-figures
description: |
  ...
  Use when working with journal-specification figure generation, multi-panel layout, color-blind safe palettes.
---
...
- Journal-specification figure generation.
- Multi-panel layout.
- Color-blind safe palettes.
- Resolution/DPI compliance.
- Figure annotation.
