---
name: co-scientist-perturbation-analysis
description: |
  ...
  Use when working with crispr screen analysis, drug perturbation response, perturbation signature comparison.
---
...
- Perturbation signature comparison.
