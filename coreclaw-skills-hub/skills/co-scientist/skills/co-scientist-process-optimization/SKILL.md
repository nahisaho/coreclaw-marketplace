---
name: co-scientist-process-optimization
description: |
  ...
  Use when working with industrial process optimization, response surface methodology, constraint optimization.
---
...
- Process parameter tuning pipelines.
