---
name: co-scientist-paleobiology
description: |
  ...
  Use when working with fossil record analysis, paleobiodiversity estimation, extinction rate calculation.
tu_tools:
  - key: pbdb
    name: PBDB
---
...
|--------|------|-------------|
| PBDB | `PBDB_search_occurrences` | PBDB API |
| PBDB | `PBDB_get_taxa` | PBDB API |
