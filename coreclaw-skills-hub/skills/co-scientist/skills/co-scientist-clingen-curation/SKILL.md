---
name: co-scientist-clingen-curation
description: |
  ...
  Use when working with gene-disease validity classification, variant pathogenicity assessment, dosage sensitivity.
tu_tools:
  - key: clingen
    name: ClinGen
---
...
- Dosage sensitivity.
- Clinical actionability curation using ClinGen resources.
...
|--------|------|-------------|
| ClinGen | `ClinGen_search_gene` | ClinGen API |
| ClinGen | `ClinGen_get_validity` | ClinGen API |
