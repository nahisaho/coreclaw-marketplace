---
name: co-scientist-clinical-nlp
description: |
  ...
  Use when working with medspacy/ctakes/scispacy-based clinical text ner, section detection, negation detection.
---
...
- MedSpaCy/cTAKES/scispaCy-based clinical text NER.
- Section detection.
- Negation detection.
