---
name: co-scientist-biobank-cohort
description: |
  ...
  Use when working with uk biobank, all of us, large-scale cohort data integration.
---

# Biobank cohort analysis
...
- UK Biobank.
- All of Us.
- Large-scale cohort data integration.
