...
description: |
  ...
  Use when working with factorial design, response surface methodology, latin hypercube sampling with auto-sized pool generation.
---
...
- Latin hypercube sampling with auto-sized pool generation.
- Taguchi methods.
- ARD-RBF Bayesian optimization.
