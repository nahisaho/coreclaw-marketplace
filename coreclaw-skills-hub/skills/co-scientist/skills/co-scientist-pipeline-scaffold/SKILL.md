---
name: co-scientist-pipeline-scaffold
description: |
  ...
  Use when working with bioinformatics pipeline scaffolding with snakemake/nextflow, workflow configuration, reproducible analysis environment setup.
---
