---
name: co-scientist-regulatory-science
description: |
  ...
  Use when working with fda/ema regulatory guidance, clinical trial regulation, drug approval pathway analysis.
---
...
- Drug approval pathway analysis.
