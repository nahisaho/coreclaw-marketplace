---
name: co-scientist-metabolomics-network
description: |
  ...
  Use when working with metabolite correlation networks, pathway-level network analysis, metabolite-gene interaction mapping.
---
