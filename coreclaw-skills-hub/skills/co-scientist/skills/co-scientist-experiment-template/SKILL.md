---
name: co-scientist-experiment-template
description: |
  ...
  Use when working with standardized experimental protocol generation, reproducible experiment setup, parameter configuration templates.
---
...
- Standardized experimental protocol generation.
- Reproducible experiment setup.
- Parameter configuration templates.
- Lab notebook formatting.
