---
name: co-scientist-gwas-catalog
description: |
  ...
  Use when working with genome-wide association study result queries, trait-variant associations, ld analysis.
tu_tools:
  - key: gwas
    name: GWAS Catalog
---
...
- Genome-wide association study result queries.
- Trait-variant associations.
- LD analysis.
- Polygenic risk score construction from GWAS Catalog data.
...
|--------|------|-------------|
| GWAS Catalog | `GWAS_search_associations` | GWAS Catalog API |
| GWAS Catalog | `GWAS_get_study` | GWAS Catalog API |
