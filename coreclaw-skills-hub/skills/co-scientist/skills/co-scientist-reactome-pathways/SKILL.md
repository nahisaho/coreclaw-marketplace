---
name: co-scientist-reactome-pathways
description: |
  ...
  Use when working with reactome pathway queries, pathway hierarchy navigation, pathway enrichment analysis.
tu_tools:
  - key: reactome
    name: Reactome
---
...
- Reactome pathway queries.
- Pathway hierarchy navigation.
- Pathway enrichment analysis.
- Pathway diagram generation.
...
| Reactome | `Reactome_get_pathway` | Reactome API |
