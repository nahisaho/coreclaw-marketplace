---
name: co-scientist-microbiome-metagenomics
description: |
  ...
  Use when working with 16s rrna analysis, shotgun metagenomics, diversity metrics.
tu_tools:
  - key: mgnify
    name: MGnify
---
...
|--------|------|-------------|
| MGnify | `MGnify_search_studies` | MGnify API |
| MGnify | `MGnify_get_analyses` | MGnify API |
