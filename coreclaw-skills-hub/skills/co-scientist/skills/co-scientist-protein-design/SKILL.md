---
name: co-scientist-protein-design
description: |
  ...
  Use when working with de novo protein design, directed evolution simulation, stability prediction.
---
...
- Protein engineering workflow support.
