---
name: co-scientist-presentation-design
description: |
  ...
  Use when working with scientific slide design, figure layout optimization, conference poster creation.
---
...
- Data visualization for oral presentations.
