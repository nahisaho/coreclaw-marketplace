---
name: co-scientist-spectral-signal
description: |
  ...
  Use when working with spectroscopy data analysis (uv-vis/nmr/ms), peak detection, spectral deconvolution.
---
...
- Spectroscopy data analysis (UV-Vis/NMR/MS).
- Peak detection.
