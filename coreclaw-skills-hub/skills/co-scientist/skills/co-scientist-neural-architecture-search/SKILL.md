---
name: co-scientist-neural-architecture-search
description: |
  ...
  Use when working with architecture space definition, search strategy implementation, performance estimation.
---
...
- Efficient NAS methods (DARTS/ENAS).
