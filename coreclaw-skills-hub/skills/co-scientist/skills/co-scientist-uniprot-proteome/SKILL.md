---
name: co-scientist-uniprot-proteome
description: |
  ...
  Use when working with uniprot protein sequence/annotation retrieval, proteome-wide queries, functional annotation extraction.
tu_tools:
  - key: uniprot
    name: UniProt
---
...
- UniProt protein sequence/annotation retrieval.
- Proteome-wide queries.
