---
name: co-scientist-environmental-geodata
description: |
  ...
  Use when working with satellite imagery analysis, remote sensing data processing, climate data integration.
tu_tools:
  - key: gbif
    name: GBIF
---

# Environmental geodata
...
| GBIF | `GBIF_get_species` | GBIF API |
