---
name: co-scientist-spatial-transcriptomics
description: |
  ...
  Use when working with visium/merfish/slide-seq data analysis, spatial gene expression mapping, spatial clustering.
---
...
- Visium/MERFISH/Slide-seq data analysis.
- Spatial gene expression mapping.
- Spatial clustering.
- Tissue region deconvolution.
