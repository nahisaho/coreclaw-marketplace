...
description: |
  ...
  Use when working with genomic data commons cancer data retrieval, mutation frequency analysis, clinical-genomic correlation.
tu_tools:
  - key: gdc
    name: GDC
---
...
|--------|------|-------------|
| GDC | `GDC_search_cases` | GDC API |
| GDC | `GDC_search_files` | GDC API |
| GDC | `GDC_get_project` | GDC API |
