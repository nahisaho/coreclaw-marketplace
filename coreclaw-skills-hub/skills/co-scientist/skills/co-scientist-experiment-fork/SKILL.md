---
name: co-scientist-experiment-fork
description: |
  ...
  Use when working with a/b test branching, experiment versioning, parameter variation management.
---
...
- Parallel experimental workflow orchestration.
