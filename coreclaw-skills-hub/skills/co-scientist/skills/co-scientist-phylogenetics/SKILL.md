---
name: co-scientist-phylogenetics
description: |
  ...
  Use when working with phylogenetic tree construction (ml/bayesian), multiple sequence alignment, divergence time estimation.
---
...
- Phylogenetic tree construction (ML/Bayesian).
- Multiple sequence alignment.
- Divergence time estimation.
- Evolutionary analysis pipelines.
