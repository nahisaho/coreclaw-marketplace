---
name: co-scientist-pharmacovigilance
description: |
  ...
  Use when working with adverse event signal detection, faers/vaers data analysis, disproportionality analysis.
tu_tools:
  - key: faers
    name: FAERS
---
...
- FAERS/VAERS data analysis.
- Disproportionality analysis.
- Drug safety signal evaluation.
...
|--------|------|-------------|
| FAERS | `FAERS_search_events` | FAERS API |
| FAERS | `FAERS_get_report` | FAERS API |
