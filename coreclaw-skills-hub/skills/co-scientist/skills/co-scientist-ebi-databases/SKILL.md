---
name: co-scientist-ebi-databases
description: |
  ...
  Use when working with embl-ebi resource integration including uniprot, pdb, chembl.
tu_tools:
  - key: ebi
    name: EBI
---
...
|--------|------|-------------|
| EBI | `EBI_search` | EBI API |
| EBI | `EBI_get_entry` | EBI API |
