---
name: co-scientist-quantum-computing
description: |
  ...
  Use when working with qiskit/cirq quantum circuit design, vqe/qaoa algorithms, quantum chemistry simulation.
---
...
- Qiskit/Cirq quantum circuit design.
- VQE/QAOA algorithms.
...
- Intermediate results must be checkpointed to files. Long-running analyses should be resumable
- Parameter sensitivity analysis should be performed for key parameters before finalizing results
