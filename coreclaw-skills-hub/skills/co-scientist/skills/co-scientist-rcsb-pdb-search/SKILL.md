---
name: co-scientist-rcsb-pdb-search
description: |
  ...
  Use when working with protein data bank structure search, advanced query construction, structure clustering.
tu_tools:
  - key: rcsb
    name: RCSB PDB
---
...
- Protein Data Bank structure search.
- Advanced query construction.
- Structure clustering.
- PDB data retrieval/parsing.
...
|--------|------|-------------|
| RCSB PDB | `RCSB_search` | RCSB PDB API |
| RCSB PDB | `RCSB_get_structure` | RCSB PDB API |
