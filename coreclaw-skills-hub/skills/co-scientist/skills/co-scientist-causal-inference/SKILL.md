---
name: co-scientist-causal-inference
description: |
  ...
  Use when working with dowhy/econml-based causal analysis, propensity score matching, instrumental variables.
---
...
- DoWhy/EconML-based causal analysis.
