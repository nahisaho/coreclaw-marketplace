---
name: co-scientist-expression-comparison
description: |
  ...
  Use when working with differential expression analysis (deseq2/edger/limma), multi-condition comparison, volcano plots.
tu_tools:
  - key: geo
    name: GEO
  - key: gtex
