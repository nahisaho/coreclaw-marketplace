---
name: co-scientist-protein-interaction-network
description: |
  ...
  Use when working with string/biogrid ppi data integration, interaction confidence scoring, network topology analysis.
tu_tools:
  - key: string
    name: STRING
  - key: uniprot
...
- STRING/BioGRID PPI data integration.
...
| STRING | `STRING_search` | STRING API |
