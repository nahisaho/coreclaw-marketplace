---
name: co-consultant-bcg-learning-capture
description: |
  Consulting learning capture for BCG-style engagements.
  Records framework insights, engagement patterns, and methodology lessons.
  Use when FINISHING a BCG engagement, discovering a framework limitation,
  or recording lessons for future BCG-style consulting sessions.
---

# Learning Capture (BCG)

Record BCG-style consulting learnings for Memory Persistence.

## Use This Skill When

- Completing a BCG consulting engagement.
- Discovering a BCG framework limitation or edge case.
- Recording lessons for future BCG-style engagements.
...
- BCG固有の知見と汎用的な知見を区別すること。BCG固有の知見はこのスイートのスキルに、汎用知見はco-consultantに記録する
