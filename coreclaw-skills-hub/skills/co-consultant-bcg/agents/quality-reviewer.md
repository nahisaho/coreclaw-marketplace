...
description: >
  Read-only BCG-style quality reviewer. Audits MECE completeness,
  BCG framework application, pyramid structure, and evidence quality.
tools:
  - read_file
  - grep_search
  - list_directory
